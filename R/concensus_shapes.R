...
plot_concensus_shapes <- function(specimen_info_file, slider_file, landmarks_file)
  
{
  ...
  for (i in 1:length(group_members)) {plot(concensus[,,i], main = paste("concensus shape",group_names[i], sep = " "))}
